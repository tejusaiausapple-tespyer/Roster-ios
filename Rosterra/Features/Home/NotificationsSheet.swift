...
/// The in-app messages inbox (manager → staff). Active (non-expired) messages,
/// newest first, auto-marked read on open. Daily Jobs used to live here; they
/// now open from the Home card → `DailyJobsView`.
